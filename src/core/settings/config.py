...
INTO_CATALOG_IMAGE_ID: str = os.getenv("INTO_CATALOG_IMAGE_ID")
ADMIN_CREATE_IMAGE_ID: str = os.getenv("ADMIN_CREATE_IMAGE_ID")
ADMIN_EDIT_IMAGE_ID: str = os.getenv("ADMIN_EDIT_IMAGE_ID")
ADMIN_DELETE_IMAGE_ID: str = os.getenv("ADMIN_DELETE_IMAGE_ID")

AFTER_FILE_ADDED_IMAGE_ID: str = os.getenv("AFTER_FILE_ADDED_IMAGE_ID")
AFTER_ADMIN_UPDATE_IMAGE_ID: str = os.getenv("AFTER_ADMIN_UPDATE_IMAGE_ID")
