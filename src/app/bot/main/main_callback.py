...
def get_main_callback():
    ...
    async def callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.callback_query.edit_message_media(
            media=InputMedia("photo", settings.MAIN_IMAGE_ID, caption=main_text),
            reply_markup=get_main_keyboard(update.callback_query.from_user.id in settings.ADMIN_IDS),
        )
